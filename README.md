...
![pictures bash for linux](https://github.com/EkaterinaSterhova/sem8Itodi/blob/main/bash.jpg)
...
### Выполнение a
#### ([перейти к скрипту](https://github.com/EkaterinaSterhova/sem8Itodi/blob/main/delfiletodir.sh)
...
### Выполнение
#### ([перейти к скрипту](https://github.com/EkaterinaSterhova/sem8Itodi/blob/main/ownersort.sh)
